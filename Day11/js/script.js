...
//   console.log(
//     `Country: ${name}, capital: ${capital}, population: ${population}, language(s): ${languages}`
//   );
// }
...
/*3 - Write a function called convertArrayToObject which can convert the array to
a structure object.*/
// const students = [
...
//     students.push({ name: name, skills: skills, scores: scores });
//   }
//   return students;
// };
